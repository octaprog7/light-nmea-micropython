...
_NAV_PACKS = (
    ...
    b"$GPVTG,084.4,T,081.3,M,022.4,N,041.5,K,A*2E\r\n",
    # 20. VTG - высокая скорость (Москва)
    b"$GNVTG,120.5,T,117.4,M,015.0,N,027.8,K,A*23\r\n",
    # 21. VTG - без Mode Indicator (старый формат)
    b"$GPVTG,270.0,T,267.0,M,045.7,N,084.6,K*60\r\n",
    # 22. GLL - координаты (Мюнхен)
    b"$GPGLL,4807.038,N,01131.000,E,123519,A,A*5C\r\n",
    # 23. GLL - координаты (Москва)
    b"$GNGLL,5545.1234,N,03737.5678,E,091530,A,A*52\r\n",
    # 24. GLL - южное полушарие (Сидней)
    b"$GNGLL,3351.5432,S,15112.3456,E,235959,A,A*55\r\n",
)
